...
import { MSG_INPUT, MSG_READY, MSG_PING, MSG_PONG, MSG_COUNTDOWN,
         MSG_ROUND_START, MSG_ROUND_END, MSG_MATCH_END, MSG_PLAYER_HIT } from '../../../shared/src/types';
...
export async function joinMatchmaking(playerId: string, displayName: string, mmr = 1000) {
  ...
  _room.onLeave(() => emit('disconnected'));
